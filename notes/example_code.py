...
out = api.get_measurements(geog_type='HUC8', geog_ids=['02060001', '02070011'], start_date='2023-01-01',
                           end_date='2024-01-01', data_variables='DIN', data_streams='traditional',
                           programs='all')
...
# out = api.get_measurements(data_variables='ACIDITY', start_date='11-24-2024', program='all')
